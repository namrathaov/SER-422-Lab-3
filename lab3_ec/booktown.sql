...
CREATE TABLE `authors` (
  ...
  `first_name` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25043 DEFAULT CHARSET=utf8;
...
CREATE TABLE `books` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41480 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-03-20 23:33:33
