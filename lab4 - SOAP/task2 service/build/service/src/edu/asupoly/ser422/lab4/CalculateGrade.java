...
/**
 *  CalculateGrade bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CalculateGrade implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":calculateGrade", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "calculateGrade", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CalculateGrade parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CalculateGrade object = new CalculateGrade();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"calculateGrade".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CalculateGrade) edu.asupoly.ser422.lab4.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://lab4.ser422.asupoly.edu", "args1").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
